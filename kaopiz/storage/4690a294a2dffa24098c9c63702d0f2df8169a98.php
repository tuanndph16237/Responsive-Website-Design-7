                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="bootstrap-table">
                            ...
                            <?php if(isset($_POST['keyword'])): ?>
                                <a style="display: inline-block; margin-top: 12px" class="btn btn-primary" href="<?php echo e(BASE_URL.'product'); ?> ">Tất cả sản phẩm</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ass_php2\app\views/products/index.blade.php ENDPATH**/ ?>